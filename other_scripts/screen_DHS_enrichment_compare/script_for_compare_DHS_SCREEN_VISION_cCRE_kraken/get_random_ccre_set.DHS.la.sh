...
cp DHS.M.withid.bed.$j'.sample.bed' DHS.M.withid.bed.$j'.sample.la.bed'
time bash Negetive_sequence_matched_length_GC.large.sh DHS.M.withid.bed.$j'.sample.la.bed' hg38.chrom.1_22XY.sizes hg38.fa 1 DHS.M.withid.bed
