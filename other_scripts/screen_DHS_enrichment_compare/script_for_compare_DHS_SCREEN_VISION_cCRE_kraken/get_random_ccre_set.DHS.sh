...
sbatch get_random_ccre_set.DHS.sm.sh $j
sbatch get_random_ccre_set.DHS.la.sh $j

#bash Negetive_sequence_matched_length_GC.merge_sm_la.sh 'DHS.M.withid.bed.'$j'.sample.sm.bed_matched.bed' 'DHS.M.withid.bed.'$j'.sample.la1.bed_matched.bed' 'DHS.M.withid.bed.'$j'.sample.bed_matched.bed'
