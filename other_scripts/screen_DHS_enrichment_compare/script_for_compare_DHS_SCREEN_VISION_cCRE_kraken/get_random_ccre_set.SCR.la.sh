...
#Rscript get_sample.pks.R SCREEN.M.withid.bed 50000 $j
cp SCREEN.M.withid.bed.$j'.sample.bed' SCREEN.M.withid.bed.$j'.sample.la.bed'
time bash Negetive_sequence_matched_length_GC.large.sh SCREEN.M.withid.bed.$j'.sample.la.bed' hg38.chrom.1_22XY.sizes hg38.fa 3 SCREEN.M.withid.bed
