...
cp SCREEN.M.withid.bed.$j'.sample.bed' SCREEN.M.withid.bed.$j'.sample.sm.bed'
time bash Negetive_sequence_matched_length_GC.small.sh SCREEN.M.withid.bed.$j'.sample.sm.bed' hg38.chrom.1_22XY.sizes hg38.fa 3 SCREEN.M.withid.bed
