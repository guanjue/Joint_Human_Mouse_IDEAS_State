...
cp S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.withid.bed.$j'.sample.bed' S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.withid.bed.$j'.sample.la.bed'
time bash Negetive_sequence_matched_length_GC.large.sh S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.withid.bed.$j'.sample.la.bed' hg38.chrom.1_22XY.sizes hg38.fa 13 S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.withid.bed
