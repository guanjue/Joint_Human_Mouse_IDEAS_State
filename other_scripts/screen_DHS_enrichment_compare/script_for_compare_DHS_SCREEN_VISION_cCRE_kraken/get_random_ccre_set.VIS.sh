...
sbatch get_random_ccre_set.VIS.sm.sh $j
sbatch get_random_ccre_set.VIS.la.sh $j

#time bash Negetive_sequence_matched_length_GC.small.sh S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.withid.bed.$j'.sample.bed' hg38.chrom.1_22XY.sizes hg38.fa 20
