...
cREs_IDEASpro_outfile = 'snapshot.hg38.barplot.pdf'
...
state_matrix = state_matrix_od[,is.element(colnames(state_matrix_od), colnames(index_matrix_od))][,-c(1:4)]
...
state_order = c(2,1,4,3,6,10,11,5,9,13,8,19,12,25,14,23,22,20,21,17,18,7,16,15,24)
