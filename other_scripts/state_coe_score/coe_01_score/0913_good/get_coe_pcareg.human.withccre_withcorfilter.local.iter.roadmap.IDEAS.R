...
setwd('/storage/home/gzx103/scratch/roadmap/IDEASmat/')
...
state_reorder = c(16,11,18,9,7,15,20,19,5,12,14,17,13,2,8,10,4,6,3,1)
...
for (iter_i in 1:1){
iter_i=1
ss00 = read.table(paste('SCREEN.cCRE.hg19.withid.S0.mat.txt', sep=''), header=F)
...
ss = read.table(paste('SCREEN.cCRE.hg19.withid.S0.mat.txt', sep=''), header=F)
ss_all = (ss[,-c(1:4)])
