...
sp_all_log_l = log(sp_all_l/rowSums(sp_all_l)+smallnum_sp)
sp_all_log_h = log(sp_all_h/rowSums(sp_all_h)+smallnum_sp)
...
sp_all_dist_log_l = log(sp_all_dist_l/rowSums(sp_all_dist_l)+smallnum_sp)
sp_all_dist_log_h = log(sp_all_dist_h/rowSums(sp_all_dist_h)+smallnum_sp)
...
set.seed(2019)
dmslog_noMean = c(dmslog_noMean_l,dmslog_noMean_h)
ds_qt_all_log = c(ds_qt_all_log_l, ds_qt_all_log_h)
...
png('pred_obs.tpm0.wg.png')
heatscatter(as.vector(pred)[used_id], as.vector(dmslog_noMean)[used_id], main=R2(c(ds_qt_all_log_l,ds_qt_all_log_h), pred), xlim=plot_lim, ylim=plot_lim)
