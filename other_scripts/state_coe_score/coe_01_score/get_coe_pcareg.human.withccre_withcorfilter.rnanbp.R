...
write.table(eRP_mat_human, 'statep_rna_coe_heatmap.human.all.rnanbp.txt', quote=F, col.names=T, row.names=T, sep='\t')
...
colnames(eRP_mat_human) = c('P','D')
rownames(eRP_mat_human) = 0:23
write.table(eRP_mat_human, 'statep_rna_coe_heatmap.human.all.ccre.withcorfilter.rnanbp.txt', quote=F, col.names=T, row.names=T, sep='\t')
...
pdf('statep_rna_coe_heatmap.human.all.ccre.withcorfilter.rnanbp.pdf', width=3)
...
pdf('statep_rna_coe_heatmap.human.all.P.ccre.withcorfilter.rnanbp.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
...
pdf('statep_rna_coe_heatmap.human.all.D.ccre.withcorfilter.rnanbp.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
...
write.table(sp_all_PD_corfilter_log, 'sp_all_PD_corfilter_log.human.rnanbp.txt', quote=F, col.names=F, row.names=F, sep='\t')
write.table(dmslog_noMean, 'dmslog_noMean.human.rnanbp.txt', quote=F, col.names=F, row.names=F, sep='\t')
