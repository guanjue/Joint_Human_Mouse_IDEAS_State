...
write.table(eRP_mat_mouse, 'statep_rna_eRP_heatmap.mouse.all.withccre.txt', quote=F, col.names=T, row.names=T, sep='\t')
...
pdf('statep_rna_coe_heatmap.mouse.all.withccre.pdf', width=3)
...
pdf('statep_rna_coe_heatmap.mouse.all.P.withccre.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
...
pdf('statep_rna_coe_heatmap.mouse.all.D.withccre.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
