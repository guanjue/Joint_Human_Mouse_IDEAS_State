...
setwd('/gpfs/group/yzz2/default/legacy/group/projects/vision_joint_human_mouse/coefficients_mouse_withccre_withcorfilter')
...
write.table(eRP_mat_mouse, 'statep_rna_coe_heatmap.mouse.all.txt', quote=F, col.names=T, row.names=T, sep='\t')
...
colnames(eRP_mat_mouse) = c('P','D')
rownames(eRP_mat_mouse) = 0:23
write.table(eRP_mat_mouse, 'statep_rna_coe_heatmap.mouse.all.ccre.withcorfilter.txt', quote=F, col.names=T, row.names=T, sep='\t')
eRP_mat_mouse
...
pdf('statep_rna_coe_heatmap.mouse.all.ccre.withcorfilter.pdf', width=3)
...
pdf('statep_rna_coe_heatmap.mouse.all.P.ccre.withcorfilter.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
...
pdf('statep_rna_coe_heatmap.mouse.all.D.ccre.withcorfilter.pdf', width=3)
rank = c(9,2,3,1,7,4,15,14,13,5,11,22,6,18,8,24,12,10,20,16,23,17,19,21)
...
write.table(sp_all_PD_corfilter_log, 'sp_all_PD_corfilter_log.mouse.txt', quote=F, col.names=F, row.names=F, sep='\t')
write.table(dmslog_noMean, 'dmslog_noMean.mouse.txt', quote=F, col.names=F, row.names=F, sep='\t')
