...
### (4) get matrix
cd /storage/home/gzx103/scratch/roadmap/chromHMMmat
### chromHMM in gene tss
bedtools intersect -a /storage/home/gzx103/scratch/roadmap/chromHMM/chromHMM.hg19.15.state -b /storage/home/gzx103/scratch/roadmap/RNA/Roadmap_hg19_f_s.idsort.protein_coding.Nkbupdownexp.bed -wa -u \
> chromHMM_hg19.state.ingene.bed
### chromHMM in ccre
#bedtools intersect -a /storage/home/gzx103/scratch/roadmap/chromHMM/chromHMM.hg19.15.state -b /storage/home/gzx103/scratch/roadmap/ccre/SCREEN.cCRE.hg19.withid.bed -wa -u \
#> chromHMM_hg19.state.inccre.bed
bedtools intersect -a /storage/home/gzx103/scratch/roadmap/chromHMM/chromHMM.hg19.15.state -b /storage/home/gzx103/scratch/roadmap/IDEAS_ccres/outputs/roadmap_ccre_IDEAS_output/roadmap_ccre_IDEAS_MP.cCRE.hg19.withid.bed -wa -u \
> chromHMM_hg19.state.inccre.bed
...
do
echo $j
cat chromHMM_hg19.state.ingene.bed \
...
do
echo $j
cat chromHMM_hg19.state.inccre.bed \
| awk -F '\t' -v OFS='\t' -v c=$j -v s=$i '{if ($c==s) print $1,$2,$3}' > ct$j.s$i.bed
### NO filter cCRE
bedtools intersect -a $source_pk -b ct$j.s$i.bed -c > ct$j.s$i.bed.count.bed
cut -f4 ct$j.s$i.bed.count.bed > ct$j.s$i.bed.count.txt
