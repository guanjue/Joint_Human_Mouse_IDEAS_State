cd /gpfs/group/yzz2/default/legacy/group/projects/vision_joint_human_mouse/coefficients_human_23ES_with_cCRE_with_corfilter
...
tail -n+2 ~/scratch/S3V2norm_compare/human_vision_S3V2/hg38bp0929_noH3K9me3_IDEAS_output1/hg38bp0929_noH3K9me3.state \
| awk -F ' ' -v OFS='\t' '{print $2,$3,$4, $0}' > hg38bp0929_noH3K9me3.state.bed
bedtools intersect -a hg38bp0929_noH3K9me3.state.bed -b /storage/home/gzx103/group/projects/vision_human/bp24_v2_cCRE_max1_IDEAS_output_A1/bp24_v2_cCRE_max1.cCRE.M.bed -wa -u \
> hg38bp0929_noH3K9me3.state.ccre.bed
cut -f4 hg38bp0929_noH3K9me3.state.ccre.bed > hg38bp0929_noH3K9me3.state.inccre


tail -n+2 ~/scratch/S3V2norm_compare/human_vision_S3V2/hg38bp0929_noH3K9me3_IDEAS_output1/hg38bp0929_noH3K9me3.state \
| awk -F ' ' -v OFS='\t' '{print $2,$3,$4, $0}' > hg38bp0929_noH3K9me3.state.bed
bedtools intersect -a hg38bp0929_noH3K9me3.state.bed -b HumanVISION_RNAseq_hg38_gene.idsort.protein_coding.Nkbupdownexp.bed -wa -u \
> hg38bp0929_noH3K9me3.state.gene.bed
cut -f4 hg38bp0929_noH3K9me3.state.gene.bed > hg38bp0929_noH3K9me3.state.ingene
...
do
echo $j
cat hg38bp0929_noH3K9me3.state.ingene \
...
do
echo $j
cat hg38bp0929_noH3K9me3.state.inccre \
