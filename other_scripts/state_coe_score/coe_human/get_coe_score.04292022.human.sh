...
time Rscript add_id.R S3V2_IDEAS_hg38_ccre2.cCRE.M.notall0.rmallNEU.bed S3V2_IDEAS_hg38_ccre2.cCRE.M.withid.bed 
bedtools intersect -a S3V2_IDEAS_hg38_ccre2.cCRE.M.withid.bed -b HumanVISION_RNAseq_hg38_gene.idsort.all.Nkbupdownexp.bed -c > S3V2_IDEAS_hg38_ccre2.cCRE.M.withid.atProximal.bed
...
do
   echo "$ct"
   time Rscript /Users/guanjuexiang/Downloads/coe_01_score/0913_good/get_coe_pcareg.human.withccre_withcorfilter.local.iter.25JES_PD.R $ct
done
