...
cat MouseVISION_RNAseq_mm10_genes_tpm.idsort.txt  \
| awk -F '\t' -v OFS='\t' '{print $1,$2,$3,$5,$6,$4}' | cut -f1,2,3,5\
...
> MouseVISION_RNAseq_mm10_genes_tpm.idsort.all.Nkbupdownexp.bed
...
time Rscript add_id.R S3V2_IDEAS_mm10_ccre2.cCRE.M.notall0.bed S3V2_IDEAS_mm10_ccre2.cCRE.M.withid.bed 
bedtools intersect -a S3V2_IDEAS_mm10_ccre2.cCRE.M.withid.bed -b MouseVISION_RNAseq_mm10_genes_tpm.idsort.all.Nkbupdownexp.bed -c > S3V2_IDEAS_mm10_ccre2.cCRE.M.withid.atProximal.bed
