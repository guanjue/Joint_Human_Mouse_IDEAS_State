...
### plot heatmap
png('cCRE_coe.human.heatmap.D.qda.spect.png', width=1200, height=1800)
...
png('cCRE_coe.human.heatmap.D.qda.clusterID.spect.png', width=200, height=1800)
...
png('cCRE_coe.human.heatmap.D.qda.meanvec.spect.png', width=1200, height=1800)
plot_lim_PD = quantile(as.numeric(as.matrix(dss)),0.995)
breaksList = seq(-plot_lim_PD, plot_lim_PD, by = 0.001)
my_colorbar=colorRampPalette(c('blue', 'white', 'red'))(n = length(breaksList))
col_breaks = c(seq(0, 2000,length=33))
