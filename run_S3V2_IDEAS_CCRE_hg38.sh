...
###### your output folder
output_dir='/storage/home/gzx103/scratch/joint_human_mouse/hg38/S3V2_IDEAS_outputs_hg38_CCRE/'
###### the absolute path to the your modified "metadata.for_master_peak_calls.txt" file
metadata='/storage/home/gzx103/scratch/joint_human_mouse/hg38/metadata.human.atac.txt'
###### The output name
id_name='S3V2_IDEAS_hg38_ccre'
