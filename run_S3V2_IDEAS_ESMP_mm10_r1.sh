...
###### your output folder
output_dir='/storage/home/gzx103/scratch/joint_human_mouse/mm10/S3V2_IDEAS_outputs_mm10/'
###### the absolute path to the your modified "metadata.for_master_peak_calls.txt" file
metadata='/storage/home/gzx103/scratch/joint_human_mouse/mm10/metadata.mouse.txt'
###### The output name
id_name='S3V2_IDEAS_mm10_r1'
